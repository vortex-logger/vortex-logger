...
// https://github.com/zenlogjs/zenlog/issues/542
test('zenlog.destination log everything when calling process.exit(0)', async ({ not }) => {
  let actual = ''
...
test('zenlog with no args log everything when calling process.exit(0)', async ({ not }) => {
  let actual = ''
