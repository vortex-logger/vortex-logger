...
const plogAsync = require('../../')(zenlog.destination({ dest: '/dev/null', sync: false }))
delete require.cache[require.resolve('../../')]
const plogUnsafe = require('../../')({ safe: false }, dest)
delete require.cache[require.resolve('../../')]
const plogUnsafeAsync = require('../../')(
  { safe: false },
  zenlog.destination({ dest: '/dev/null', sync: false })
)
const plogRedact = zenlog({ redact: ['a.b.c'] }, dest)
delete require.cache[require.resolve('../../')]
